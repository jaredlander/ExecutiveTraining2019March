...
# Comps America
download.file(
    'https://query.data.world/s/kgenbafpmi7hedt3zyg24zzab46g7q',
    destfile=file.path(dataDir, 'Comps', 'Comp_Americas.xlsx'),
    mode='wb')

# Comps Asia
download.file(
    'https://query.data.world/s/vne7y6lgwhhtc7nall65gizgzqd3gt',
    destfile=file.path(dataDir, 'Comps', 'Comp_AsiaPacific.xlsx'),
    mode='wb')

# Comps Europe
download.file(
    'https://query.data.world/s/kbrhn5xi7tkgbfprxsbeotirbxcvfr',
    destfile=file.path(dataDir, 'Comps', 'Comp_Europe.xlsx'),
    mode='wb')

# Comps Switzerland
download.file(
    'https://query.data.world/s/eljm67d43bojcf5epmhtb3qige6au5',
    destfile=file.path(dataDir, 'Comps', 'Comp_Switzerland.xlsx'),
    mode='wb')
